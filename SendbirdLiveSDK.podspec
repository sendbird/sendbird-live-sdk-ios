Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-live-sdk-ios/releases/download/v1.5.1/SendbirdLiveSDK.zip", :sha1 => "6264f760f121030e734cc080e2148f335519e906" }
  s.requires_arc = true
  s.platform = :ios, '14.0'
  ...
  s.dependency "SendBirdWebRTC", "~> 1.9.0"

Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-live-sdk-ios/releases/download/v1.0.0-beta.8/SendbirdLiveSDK.zip", :sha1 => "f4cfa01632636c5c2f1e8c5ccf3fceda395a0ed5" }
  s.requires_arc = true
  s.platform = :ios, '11.0'

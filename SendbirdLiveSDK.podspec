Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-live-sdk-ios/releases/download/v1.0.0-beta.12/SendbirdLiveSDK.zip", :sha1 => "201fe4b03a91532ab8219052999865fb644e1135" }
  s.requires_arc = true
  s.platform = :ios, '11.0'
